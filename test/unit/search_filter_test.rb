...
module Elasticsearch
  module Test
    class SearchFilterTest < ::Elasticsearch::Test::UnitTestCase
      subject { Elasticsearch::DSL::Inquiry::Filter.new }
      ...
      context "Search Filter" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = Elasticsearch::DSL::Inquiry::Filter.new &block

          subject.expects(:instance_eval)
          assert_instance_of Elasticsearch::DSL::Inquiry::Filter, subject.call
        end
