    ...
    class BaseAggregationComponentTest < ::Elasticsearch::Test::UnitTestCase
      context "BaseAggregationComponent" do
        ...
        class DummyAggregationComponent
          include ::Elasticsearch::DSL::Inquiry::BaseAggregationComponent
        end

        class ::Elasticsearch::DSL::Inquiry::Aggregations::Dummy
          include ::Elasticsearch::DSL::Inquiry::BaseAggregationComponent
        end
        ...
        should "return an instance of the aggregation by name" do
          assert_instance_of ::Elasticsearch::DSL::Inquiry::Aggregations::Dummy, subject.dummy
        end
        ...
        should "add a nested aggregation" do
          ...
          assert_instance_of Elasticsearch::DSL::Inquiry::Aggregation, subject.aggregations[:inner]
