    ...
    class SearchSortTest < ::Elasticsearch::Test::UnitTestCase
      ...
      context "Search sort" do
        ...
        should "not be empty" do
          subject = Elasticsearch::DSL::Inquiry::Sort.new foo: { order: 'desc' }
