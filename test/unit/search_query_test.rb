...
module Elasticsearch
  module Test
    class SearchQueryTest < ::Elasticsearch::Test::UnitTestCase
      subject { Elasticsearch::DSL::Inquiry::Query.new }
      ...
      context "Search Query" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = Elasticsearch::DSL::Inquiry::Query.new &block

          subject.expects(:instance_eval)
          assert_instance_of Elasticsearch::DSL::Inquiry::Query, subject.call
        end
